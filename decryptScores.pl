...
#  while (1) {
#	my $i = 0;my $n = 0;my @gene_name = "";
#        binmode info; my $s = "";
#        while (($n = read info, $s, 1) != 0){# if($n==0){last;}
#		if ($s eq "	") {
#			$n = read info, $s, 1; if($n==0) {last;}
#			if($s eq "	")
#				{ last;}
#			else {
#	       			$gene_name[$i++]="	";
...
#	if ($n == 0) {last;}
#
#	my @part = join('', @gene_name);
#	$gene = $cipher->decrypt(@part); #decrypt the second column
#
#	my $i = 0;my $n = 0;my @gene_name = "";
#        binmode info; my $s = "";
#        while (($n = read info, $s, 1) != 0){# if($n==0){last;}
